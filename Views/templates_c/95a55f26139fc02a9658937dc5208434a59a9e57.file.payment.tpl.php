<?php /* Smarty version Smarty-3.1.21-dev, created on 2015-08-17 17:13:19
         compiled from "Views\templates\page\payment.tpl" */ ?>
<?php /*%%SmartyHeaderCode:613755d1fa0f8e6fe7-70060205%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '95a55f26139fc02a9658937dc5208434a59a9e57' => 
    array (
      0 => 'Views\\templates\\page\\payment.tpl',
      1 => 1431796120,
      2 => 'file',
    ),
    ...
    'dd812bede0368f7108706aab50093fcfcdaf69bb' => 
    array (
      0 => 'Views\\templates\\block\\block-payment.tpl',
      1 => 1431955010,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '613755d1fa0f8e6fe7-70060205',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55d1fa10b9b801_63922573',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55d1fa10b9b801_63922573')) {function content_55d1fa10b9b801_63922573($_smarty_tpl) {?><!DOCTYPE html>
<html lang="">
	<head>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("head.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '613755d1fa0f8e6fe7-70060205');
content_55d1fa0fd21200_59943595($_smarty_tpl);
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("header.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '613755d1fa0f8e6fe7-70060205');
content_55d1fa0fef5180_04694360($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("container.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '613755d1fa0f8e6fe7-70060205');
content_55d1fa10225ff1_28197622($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("footer.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '613755d1fa0f8e6fe7-70060205');
content_55d1fa10ad0003_56407599($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("plugin.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '613755d1fa0f8e6fe7-70060205');
content_55d1fa10b541b8_75647613($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
<?php if ($_valid && !is_callable('content_55d1fa0fd21200_59943595')) {function content_55d1fa0fd21200_59943595($_smarty_tpl) {?><meta charset="utf-8">
...
<?php if ($_valid && !is_callable('content_55d1fa0fef5180_04694360')) {function content_55d1fa0fef5180_04694360($_smarty_tpl) {?><div class="container-fluid">
...
<?php /* Smarty version Smarty-3.1.21-dev, created on 2015-08-17 17:13:20
         compiled from "Views\templates\container.tpl" */ ?>
<?php if ($_valid && !is_callable('content_55d1fa10225ff1_28197622')) {function content_55d1fa10225ff1_28197622($_smarty_tpl) {?><div class="container">
    <div class="row">
    <?php /*  Call merged included template "block/block-container-one.tpl" */
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("block/block-container-one.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '613755d1fa0f8e6fe7-70060205');
content_55d1fa10245d68_64676605($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
<?php if ($_valid && !is_callable('content_55d1fa10245d68_64676605')) {function content_55d1fa10245d68_64676605($_smarty_tpl) {?><?php /*  Call merged included template "block/block-payment.tpl" */
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("block/block-payment.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '613755d1fa0f8e6fe7-70060205');
content_55d1fa103fb8b9_81742625($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
/*  End of included template "block/block-payment.tpl" */?>
<?php }} ?>
<?php /* Smarty version Smarty-3.1.21-dev, created on 2015-08-17 17:13:20
         compiled from "Views\templates\block\block-index.tpl" */ ?>
<?php if ($_valid && !is_callable('content_55d1fa10263f14_89577125')) {function content_55d1fa10263f14_89577125($_smarty_tpl) {?><div class="col-lg-22 col-lg-offset-1 indexpage">
	<div class="row">
...
<?php /* Smarty version Smarty-3.1.21-dev, created on 2015-08-17 17:13:20
         compiled from "Views\templates\block\block-payment.tpl" */ ?>
<?php if ($_valid && !is_callable('content_55d1fa103fb8b9_81742625')) {function content_55d1fa103fb8b9_81742625($_smarty_tpl) {?><?php echo '<script'; ?>
>
$(document).ready(function(){
		...
		<div class="row">
			<div class="customer">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" id="txtname" value="<?php if (isset($_SESSION['temp'])) {
...
echo $_SESSION['customer']['customer_name'];
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" id="txtphone" value="<?php if (isset($_SESSION['temp'])) {
echo $_SESSION['temp']['phone'];
} else {
echo $_SESSION['customer']['phone'];
				...
				<div class="form-group">
					...
					<label class="radio-inline"><input type="radio" name="radioSex" value="0" <?php if (isset($_SESSION['temp'])&&$_SESSION['temp']['sex']==0) {?> checked <?php } elseif ($_SESSION['customer']['sex']==0) {?> checked<?php }?>>Nam</label>
					<label class="radio-inline"><input type="radio" name="radioSex" value="1" <?php if (isset($_SESSION['temp'])&&$_SESSION['temp']['sex']==1) {?> checked <?php } elseif ($_SESSION['customer']['sex']==1) {?> checked<?php }?>>Nữ</label>
				</div>
				<div class="form-group">
					<label for="txtaddress">Địa chỉ</label>
					<textarea type="text" class="form-control" id="txtaddress"><?php if (isset($_SESSION['temp'])) {
		...
		<div class="row">
			<div class="consignee">
				...
				<div class="form-group">
					...
					<div class="radio">
						<label class="radio-inline"><input type="radio" name="rbdconsignee" value="1" <?php if (isset($_SESSION['temp'])&&$_SESSION['temp']['consignee']==1) {?>checked<?php }?>>Giao hàng tới địa chỉ khác</label>
					</div>
				</div>
				<div id="different" class="hidden">
					<div class="form-group">
						<label for="txtname">Tên khách hàng</label>
						<input type="text" class="form-control" id="txtname1" value="<?php if (isset($_SESSION['temp'])) {
echo $_SESSION['temp']['name1'];
} else {
echo $_SESSION['customer']['customer_name'];
}?>">
					</div>
					<div class="form-group">
						<label for="txtphone">Số điện thoại</label>
						<input type="text" class="form-control" id="txtphone1" value="<?php if (isset($_SESSION['temp'])) {
echo $_SESSION['temp']['phone1'];
} else {
echo $_SESSION['customer']['phone'];
}?>">
					</div>
					<div class="form-group">
						<label for="txtaddress">Địa chỉ</label>
						<textarea type="text" class="form-control" id="txtaddress1"><?php if (isset($_SESSION['temp'])) {
echo $_SESSION['temp']['address1'];
} else {
echo $_SESSION['customer']['address'];
}?></textarea>
					</div>
		...
		<div class="row">
			<div class="note">
				<h3>GHI CHÚ</h3>
				<textarea type="text" class="form-control" id="txtnote"><?php if (isset($_SESSION['temp'])) {
echo $_SESSION['temp']['note'];
} else { ?>Liên hệ trước khi giao hàng. Giao hàng sau 17h...<?php }?></textarea>
			</div>
		</div>
	</aside>
...
<?php if ($_valid && !is_callable('content_55d1fa10ad0003_56407599')) {function content_55d1fa10ad0003_56407599($_smarty_tpl) {?><div class="container-fluid">
...
<?php if ($_valid && !is_callable('content_55d1fa10b541b8_75647613')) {function content_55d1fa10b541b8_75647613($_smarty_tpl) {?><div id="plugin">
